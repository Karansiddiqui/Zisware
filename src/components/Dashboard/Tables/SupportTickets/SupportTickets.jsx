            ...
            return (
              <tr key={index} className="">
                ...
                <td className="px-3 py-4 w-48">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-textColor hover:text-blue-500 transition-all duration-200 hover:cursor-pointer">
                        {ticket.user.name}
                      </span>
                      <div className="flex gap-2 items-center  text-gray-500 ">
                        <span
                          className={`inline-flex items-center h-[10px] w-[10px] rounded-full  font-medium ${getPriorityColor(
                            ticket.priority
                          )}`}
                        ></span>
                ...
                <td className="px-3 py-4">
                  <div className="flex flex-col">
                    <span className="  text-sm font-semibold text-textColor hover:cursor-pointer hover:text-blue-500 transition-all duration-200">
    ...
    <div className="w-full bg-white flex items-center justify-center  border border-borderColor text-sm">
      <div className="w-full bg-white rounded-xl shadow-sm">
        <div className="bg-white border-borderColor ">
          ...
          <div className="flex flex-col lg:flex-row justify-between lg:items-center xl:gap-4">
