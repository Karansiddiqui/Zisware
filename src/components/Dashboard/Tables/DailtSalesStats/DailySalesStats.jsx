  ...
  return (
    <div className="flex gap-4 h-fit">
      {cardData.map((card, index) => (
        <div className="border border-borderColor p-4 bg-white h-fit flex flex-col justify-center items-center gap-6">
          {card.svg1}
          ...
          <div className="xl:block hidden">{card.svg2}</div>
        </div>
      ))}
    </div>
  );
