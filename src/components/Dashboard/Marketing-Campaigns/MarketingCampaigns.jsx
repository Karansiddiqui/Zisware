        ...
        <div className="bg-white border-b border-borderColor ">
          ...
          <div className="flex justify-between md:items-center  flex-col md:flex-row">
            ...
            <div className=" px-4 pb-4 md:pb-0">
              <button className="bg-[#5c6bc0]   hover:bg-[#5360ad] transition-all duration-200 font-medium text-white px-4 py-2 text-xs rounded-md flex gap-3 items-center">
          ...
          <table className="w-full text-nowrap">
            ...
            <tbody className="divide-y divide-borderColor ">
              <tr className="border-b border-borderColor bg-gray-100">
                <td
                  colSpan="5"
                  className="py-[14px]  px-4 text-sm text-gray-800"
                >
                  Today
                </td>
